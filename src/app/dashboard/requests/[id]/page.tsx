      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm mb-8 overflow-hidden">
          <div className="px-6 py-5 border-b border-gray-100">
            <h2 className="text-lg font-semibold text-gray-900">Loan Request Progress</h2>
          </div>
          <div className="p-6">
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div 
                ...
                className="bg-gradient-to-br from-white to-blue-50/30 rounded-2xl p-5 border border-blue-100/50 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer hover:bg-blue-50/20"
              >
              ...
              <div 
                ...
                className="bg-gradient-to-br from-white to-purple-50/30 rounded-2xl p-5 border border-purple-100/50 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer hover:bg-purple-50/20"
              >
                <div className="flex items-center gap-3 mb-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-purple-500 to-purple-600 rounded-full transition-all duration-700 ease-in-out"
              ...
              <div 
                onClick={() => setActiveModule('escrow-title')}
                className="bg-gradient-to-br from-white to-indigo-50/30 rounded-2xl p-5 border border-indigo-100/50 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer hover:bg-indigo-50/20"
              >
                <div className="flex items-center gap-3 mb-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-full transition-all duration-700 ease-in-out"
              ...
              <div 
                ...
                className="bg-gradient-to-br from-white to-emerald-50/30 rounded-2xl p-5 border border-emerald-100/50 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer hover:bg-emerald-50/20"
              >
                <div className="flex items-center gap-3 mb-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-full transition-all duration-700 ease-in-out"
              ...
              <div 
                ...
                className="bg-gradient-to-br from-white to-amber-50/30 rounded-2xl p-5 border border-amber-100/50 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer hover:bg-amber-50/20"
              >
                <div className="flex items-center gap-3 mb-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-amber-500 to-amber-600 rounded-full transition-all duration-700 ease-in-out"
              ...
              <div 
                ...
                className="bg-gradient-to-br from-white to-rose-50/30 rounded-2xl p-5 border border-rose-100/50 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer hover:bg-rose-50/20"
              >
                <div className="flex items-center gap-3 mb-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-rose-500 to-rose-600 rounded-full transition-all duration-700 ease-in-out"
